# Y.M.I Roofing — Phase 2

**Growth Package · Prepared by Aurora AI Agency for Ben Breheny**

---

Hi Ben,

Phase 1 built the foundation — a fast, mobile-first website, your real work on
display, a quick-answer assistant, and the plumbing for analytics and reviews. It's
built to **convert** someone who's already found you.

Phase 2 is about the other half: **getting found**, and turning one-off jobs into a
...
- Mobile-first website with a permanent "Call Ben" bar and quick-answer chat
- "Our Work" gallery from your real photos, sharpened and optimised
- Local SEO groundwork — Melton + western-suburbs targeting, structured data, an
  "Areas We Serve" section, FAQ schema
- Analytics + Google review buttons pre-wired (switch on when you send the links)
- Privacy policy and terms drafted with Australian Consumer Law in mind
...
*Re-pointing Bacchus Marsh* — each written for how people in that suburb search.
- 4–6 priority suburbs to start, built on the existing site
- Real local references, internal links, per-suburb schema
- **Why it pays:** one page per suburb is how you rank in more than just Melton.

### 3. Review machine  🟢 *compounds over time*
The automation is already speced — Phase 2 switches it on.
- Job finishes → customer gets a friendly review request next day, polite nudge at day 3
- Bookmark-tap trigger so you fire it from your phone on site
...
- ManyChat 24/7 auto-responder (spec already written) routing urgent repairs to your phone
- **Why it pays:** social proof for the hesitant, and a net that catches after-hours enquiries.
...
These are add-ons to your existing retainer — mix and match. Final quote confirmed
before anything starts, and nothing begins without your go-ahead.
...
*No GST charged — Aurora isn't registered for GST. Third-party costs (Twilio, ManyChat,
ad spend) are billed to you directly by the provider and stay in your name.*
