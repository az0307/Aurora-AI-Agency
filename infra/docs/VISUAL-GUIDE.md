...
cpx31 plan; the box is now a **Hetzner CX33 in Nuremberg** (same software, same diagram).
...
| 5 | **Create aurora-01** (confirm with `y`): Hetzner CX33 with an SSH + Tailscale firewall | server | SETUP.md §1 |
