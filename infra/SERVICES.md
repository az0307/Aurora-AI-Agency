...
**Good candidates to add later** (documented, not built): LibreTranslate (offline
translation), faster-whisper (STT — CPU-ok for short clips, GPU for volume), Docling/
Unstructured (richer doc parsing), a generic Python/Node code-sandbox image.
