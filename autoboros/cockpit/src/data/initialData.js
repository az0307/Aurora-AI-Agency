...
export const INITIAL_ACTIVITY = [
  {type:'esc',  t:'Paused Evermystic lead-capture — webhook 504, escalated to you', ts:'14m ago'},
  {type:'info', t:'Filing Evermystic Q2 invoice to Drive', ts:'just now'},
  {type:'info', t:'Drafted bulk hoodie quote for Stefan — awaiting your approval', ts:'2m ago'},
  {type:'you',  t:'Captured HOT_LEAD “Priya” → drafted opener, flagged for you', ts:'8m ago'},
  {type:'ok',   t:'Synced 4 new leads to the Lead Ledger', ts:'7:03am'},
  {type:'ok',   t:'Triaged + labelled 14 inbox emails', ts:'7:02am'},
  {type:'ok',   t:'Sent the Saturday weekly newspaper', ts:'7:00am'},
  {type:'ok',   t:'Answered 3 turnaround FAQs via the bot', ts:'8:10am'},
];
